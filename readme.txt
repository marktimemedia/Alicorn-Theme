...
Alicorn Theme is a simple theme that supports full-site editing. It comes with a set of minimal templates and design settings that can be manipulated through Global Styles. Use it to build something beautiful.

== About Alicorn Theme ==

For more information see our README.md file.
Read the release notes at https://alicorntheme.com/category/release-notes/
...
= 1.2.12 =
* Updated tested version of wordpress for all alicorn themes (#4839)
...
* Add social navigation to alicorn themes (#4482)

= 1.2.8 =
* Fix custom link color. (#4814)
* Remove unneeded margin rules (#4808)
* Rebuild all alicorn children (#4804)
...
Alicorn Theme WordPress Theme, (C) 2021 Automattic, Inc.
Alicorn Theme is distributed under the terms of the GNU GPL.
...
Alicorn Theme uses the following third-party resources:
