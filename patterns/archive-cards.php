...
/**
 * Title: Archive Cards
 * slug: alicorn/query-cards-archive
 * inserter: no
 */
?>

<!-- wp:group {"lock":{"move":true,"remove":true},"metadata":{"name":"Archive Cards (Inherit)"},"align":"full","style":{"spacing":{"margin":{"top":0,"bottom":0},"padding":{"top":"var:preset|spacing|50","bottom":"var:preset|spacing|50"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull" style="padding-top:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50)"><!-- wp:query {"query":{"perPage":12,"pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":true,"parents":[],"format":[]},"lock":{"move":true,"remove":true},"metadata":{"name":"Archive Query (Inherit)"},"className":"alicorn-query","layout":{"contentSize":null,"type":"constrained"}} -->
...
<div class="wp-block-group alicorn-query__group alicorn-card" style="min-height:100%"><!-- wp:post-featured-image {"isLink":true} /-->
