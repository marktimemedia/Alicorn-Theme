...
function alicorn_condition_to_render_social_menu( $block_content, $block ) {
...
function alicorn_theme_has_navigation_social_links_settings( $theme_data ) {
	return $theme_data
...
function get_social_menu_as_social_links_block( $block ) {
	...
	if ( alicorn_theme_has_navigation_social_links_settings( $theme_data ) ) {
...
function alicorn_social_menu_render( $block_content, $block ) {
	if ( alicorn_condition_to_render_social_menu( $block_content, $block ) ) {
 ...
 */
add_filter( 'render_block', 'alicorn_social_menu_render', 10, 2 );
