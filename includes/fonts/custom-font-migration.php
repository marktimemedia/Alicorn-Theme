...
add_action( 'init', 'migrate_alicorn_custom_fonts', 99 );

function migrate_alicorn_custom_fonts() {
	// The data has already been transformed
	if ( get_theme_mod( 'alicorn_legacy_font_settings' ) ) {
		return;
	}
	...
	set_theme_mod( 'blocspring_legacy_font_settings', true );
}
